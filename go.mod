...
require (
	...
	github.com/tsingsun/woocoo/contrib/gql v0.0.3-0.20240508025056-6bd1a67bbaa8
	github.com/tsingsun/woocoo/contrib/telemetry v0.1.5-0.20240318150039-7ad15a0fe23e
