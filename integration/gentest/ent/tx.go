...
func (tx *Tx) init() {
	tx.ExGIDSchema = NewExGIDSchemaClient(tx.config)
	tx.RefSchema = NewRefSchemaClient(tx.config)
...
// applies a query, for example: ExGIDSchema.QueryXXX(), the query will be executed
