...
func (_q *UserQuery) QueryRefs() *RefSchemaQuery {
	query := (&RefSchemaClient{config: _q.config}).Query()
...
func (_q *UserQuery) WithRefs(opts ...func(*RefSchemaQuery)) *UserQuery {
	query := (&RefSchemaClient{config: _q.config}).Query()
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withRefs; query != nil {
	...
	for name, query := range _q.withNamedRefs {
		if err := _q.loadRefs(ctx, query, nodes,
...
func (_q *UserQuery) loadRefs(ctx context.Context, query *RefSchemaQuery, nodes []*User, init func(*User), assign func(*User, *RefSchema)) error {
...
func (_q *UserQuery) WithNamedRefs(name string, opts ...func(*RefSchemaQuery)) *UserQuery {
	query := (&RefSchemaClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedRefs == nil {
		_q.withNamedRefs = make(map[string]*RefSchemaQuery)
	}
	_q.withNamedRefs[name] = query
	return _q
}
