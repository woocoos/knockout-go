...
const (
	...
	// Node types.
	TypeExGIDSchema = "ExGIDSchema"
	TypeRefSchema   = "RefSchema"
	TypeUser        = "User"
)

// ExGIDSchemaMutation represents an operation that mutates the ExGIDSchema nodes in the graph.
type ExGIDSchemaMutation struct {
	config
	op            Op
	typ           string
	id            *int
	...
	oldValue      func(context.Context) (*ExGIDSchema, error)
	predicates    []predicate.ExGIDSchema
}

var _ ent.Mutation = (*ExGIDSchemaMutation)(nil)

// exgidschemaOption allows management of the mutation configuration using functional options.
type exgidschemaOption func(*ExGIDSchemaMutation)

// newExGIDSchemaMutation creates new mutation for the ExGIDSchema entity.
func newExGIDSchemaMutation(c config, op Op, opts ...exgidschemaOption) *ExGIDSchemaMutation {
	m := &ExGIDSchemaMutation{
		config:        c,
		op:            op,
		typ:           TypeExGIDSchema,
...
// withExGIDSchemaID sets the ID field of the mutation.
func withExGIDSchemaID(id int) exgidschemaOption {
	return func(m *ExGIDSchemaMutation) {
		var (
			err   error
			once  sync.Once
			value *ExGIDSchema
		)
		m.oldValue = func(ctx context.Context) (*ExGIDSchema, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().ExGIDSchema.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withExGIDSchema sets the old ExGIDSchema of the mutation.
func withExGIDSchema(node *ExGIDSchema) exgidschemaOption {
	return func(m *ExGIDSchemaMutation) {
		m.oldValue = func(context.Context) (*ExGIDSchema, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
func (m ExGIDSchemaMutation) Client() *Client {
...
func (m ExGIDSchemaMutation) Tx() (*Tx, error) {
...
func (m *ExGIDSchemaMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *ExGIDSchemaMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	...
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().ExGIDSchema.Query().Where(m.predicates...).IDs(ctx)
	default:
...
func (m *ExGIDSchemaMutation) SetName(s string) {
	m.name = &s
}

// Name returns the value of the "name" field in the mutation.
func (m *ExGIDSchemaMutation) Name() (r string, exists bool) {
	v := m.name
	if v == nil {
		return
	}
...
// OldName returns the old "name" field's value of the ExGIDSchema entity.
// If the ExGIDSchema object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ExGIDSchemaMutation) OldName(ctx context.Context) (v string, err error) {
...
func (m *ExGIDSchemaMutation) ResetName() {
	m.name = nil
}

// Where appends a list predicates to the ExGIDSchemaMutation builder.
func (m *ExGIDSchemaMutation) Where(ps ...predicate.ExGIDSchema) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the ExGIDSchemaMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *ExGIDSchemaMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.ExGIDSchema, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
func (m *ExGIDSchemaMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *ExGIDSchemaMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (ExGIDSchema).
func (m *ExGIDSchemaMutation) Type() string {
	return m.typ
}
...
// AddedFields().
func (m *ExGIDSchemaMutation) Fields() []string {
	fields := make([]string, 0, 1)
	if m.name != nil {
		fields = append(fields, exgidschema.FieldName)
	}
	return fields
}
...
// schema.
func (m *ExGIDSchemaMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// database failed.
func (m *ExGIDSchemaMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case exgidschema.FieldName:
		return m.OldName(ctx)
	}
	return nil, fmt.Errorf("unknown ExGIDSchema field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ExGIDSchemaMutation) SetField(name string, value ent.Value) error {
	switch name {
	case exgidschema.FieldName:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown ExGIDSchema field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *ExGIDSchemaMutation) AddedFields() []string {
	return nil
}
...
func (m *ExGIDSchemaMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ExGIDSchemaMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown ExGIDSchema numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *ExGIDSchemaMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *ExGIDSchemaMutation) FieldCleared(name string) bool {
...
func (m *ExGIDSchemaMutation) ClearField(name string) error {
	return fmt.Errorf("unknown ExGIDSchema nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *ExGIDSchemaMutation) ResetField(name string) error {
	switch name {
	case exgidschema.FieldName:
		m.ResetName()
		return nil
...
func (m *ExGIDSchemaMutation) AddedEdges() []string {
...
func (m *ExGIDSchemaMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *ExGIDSchemaMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
func (m *ExGIDSchemaMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *ExGIDSchemaMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
func (m *ExGIDSchemaMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *ExGIDSchemaMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown ExGIDSchema unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *ExGIDSchemaMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown ExGIDSchema edge %s", name)
}
